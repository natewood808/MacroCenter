...
namespace SportsStore.Components
{
    ...
    /// HTTP requests.
    /// </summary>
    public class PriceMenuViewComponent : ViewComponent
    {
        private IProductRepository repository;

        /// <summary>
        /// Whenever MVC needs an instance of PriceMenuViewComponent it will go to the
        ...
        public PriceMenuViewComponent(IProductRepository repo)
        {
            repository = repo;
        }
        /// <summary>
        ...
        public IViewComponentResult Invoke()
        {
            ...
            ViewBag.SelectedPriceSort = RouteData?.Values["price"];
